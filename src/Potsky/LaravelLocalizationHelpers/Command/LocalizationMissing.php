...
class LocalizationMissing extends LocalizationAbstract
{
    ...
    protected function getOptions()
    {
        return [
            ...
            ['new-value', 'l', InputOption::VALUE_OPTIONAL, 'Value of new found lemmas (use %LEMMA for the lemma value or translation). Set it to null to provide translation fallbacks.', 'TODO: %LEMMA'],
